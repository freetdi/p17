...
public: // iter types
	...
	public: // construct/move
		const_iterator(TRIE const& t, NODEp* scratch=NULL, bool end=false)
		    : _stack(scratch?scratch:new_range_scratch(t)),
...
template<class TRIE, class PRED=some_true>
